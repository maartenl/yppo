...
public class VerifyListener implements JobListener, StepListener, ItemProcessListener, ItemReadListener, ItemWriteListener
{

    private static final Logger LOGGER = Logger.getLogger(VerifyListener.class.getName());
